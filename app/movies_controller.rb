...
def can_be_created_with_a_hash_of_attributes
  ...
  # is there a more programmatic way of doing
  movie = Movie.create(attributes)
  
end

def can_be_created_in_a_block(att = {:title => "Home Alone", :release_date => 1990})
  ...
  Movie.create do |m|
    m.title = att[:title]
    m.release_date = att[:release_date]
    #binding.pry
  end
end
...
def can_get_size_of_the_database
  Movie.all.size
  #why does this need .all but the others dont?
end
